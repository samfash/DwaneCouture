...
dotenv.config();
export const createUser = async (email, hashedPassword, role, isOAuth = false) => {
    const query = `
...
export const updateUserResetToken = async (userId, resetToken, expiry) => {
    const query = `
    UPDATE users 
...
export const createOAuthUser = async (email) => {
