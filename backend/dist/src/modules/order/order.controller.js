import { createOrderService, getUserOrdersService, getOrderService, updateOrderStatusService, deleteOrderService, } from "./order.service";
...
export const updateOrderStatusController = async (req, res) => {
    try {
        ...
        logger.error(`❌ UpdateOrderStatusController Error: ${error.message}`);
        res.status(500).json({ error: "Server Error" });
        return;
    }
};
