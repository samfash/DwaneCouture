import { handleProfileCreation, fetchUserProfile, updateUserProfileWithMeasurements, } from "./profile.service";
import { profileSchema, maleMeasurementsSchema, femaleMeasurementsSchema, updateMaleMeasurementsSchema, updateFemaleMeasurementsSchema } from "./profile.validation";
...
export const createProfileController = async (req, res) => {
    try {
        ...
        const measurementsParse = gender === "male"
