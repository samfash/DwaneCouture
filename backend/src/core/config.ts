...
export default {
  ...
  database: {
    user: process.env.SUPA_USER || process.env.DB_USER,
    password: process.env.SUPA_PASS || process.env.DB_PASS,
    host: process.env.SUPA_HOST ||  process.env.DB_HOST,
    name: isTest ? process.env.TEST_DATABASE_NAME : process.env.SUPA_DB || process.env.DB_NAME,
    port: Number(process.env.SUPA_PORT) || Number(process.env.DB_PORT),
    db_url: isTest ? process.env.TEST_DATABASE_URL : process.env.SUPA_SESS || process.env.DATABASE_URL,
  },
  auth: {
